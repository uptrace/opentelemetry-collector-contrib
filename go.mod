...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/uptraceexporter v0.0.0-00010101000000-000000000000
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/exporter/uptraceexporter => ./exporter/uptraceexporter
